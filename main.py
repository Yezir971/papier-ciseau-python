from app.utils import play_game
from app.interface import interface_menu_game, machine, choice_player
...
def main():
    ...
    while is_run:
        ...
        interface_menu_game()
        first_choice = choice_player("Prêt à relever le défi ?", "Jouer", "Jouer", "Code de triche", "Quitter")
